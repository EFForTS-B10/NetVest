...
nl <- readRDS(file.path(main.dir, "sims_wages_distinct_v10_replicates.rds"))
...
util.ggsave(plot=p_landscape, filename="initial_landscape", path=main.dir, units = "cm", width=10, height=10, dpi=300)


####################################################
### Plot 1: Oilpalm area:
p_op_area <- pf_lines(res_agg_yield, "oilpalm_area", "oilpalm area \n [fraction of agricultural area]")
util.ggsave(plot=p_op_area, filename="lines_oilpalm_area", path=main.dir, units = "cm", width=10, height=5, dpi=300)
...
util.ggsave(plot=pall, filename="lines_yields", path=main.dir, units = "cm", width=10, height=10, dpi=300)
...
util.ggsave(plot=pall, filename="lines_household_size", path=main.dir, units = "cm", width=10, height=20, dpi=300)
...
util.ggsave(plot=p_ed, filename="lines_landscape", path=main.dir, units = "cm", width=10, height=5, dpi=300)
...
util.ggsave(plot=pall, filename="lines_ef", path=main.dir, units = "cm", width=10, height=15, dpi=300)
...
util.ggsave(plot=pall, filename="lines_panel", path=main.dir, units = "cm", width=20, height=25, dpi=300)
...
util.ggsave(filename="hull_ef", path=main.dir, units = "cm", width=10, height=15, dpi=300)
...
util.ggsave(filename="bar_ef", path=main.dir, units = "cm", width=12, height=10, dpi=300)
...
util.ggsave(filename="src_striped", path=main.dir, units = "cm", width=15, height=15, dpi=300)
...
util.ggsave(filename="src_grid", path=main.dir, units = "cm", width=15, height=15, dpi=300)
