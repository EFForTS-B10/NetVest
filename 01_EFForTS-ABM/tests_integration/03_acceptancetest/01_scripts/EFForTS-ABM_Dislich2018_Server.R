...
outpath <- file.path("/home/dockerj/EFForTS-ABM/01_EFForTS-ABM/tests_integration/03_acceptancetest/02_output")
...
nl@experiment <- experiment(expname="acceptance_test",
                            outpath=outpath,
                            repetition=20,
                            tickmetrics="true",
