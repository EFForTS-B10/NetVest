...
variable_list <- list("\"hundred-farmers3\"")#"general", "server"3478436
names(variable_list) <- c("which-map")#"rand-seed","dummy_variable", "biodiv_invest_objective")#, "which-machine?"
