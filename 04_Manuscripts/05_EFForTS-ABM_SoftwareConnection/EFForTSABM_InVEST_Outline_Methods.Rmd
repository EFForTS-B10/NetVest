...
author: Julia Henzler^1^*, Nils Beyer^1^, Sebastian Hanss^1^, Craig Eric Simpkins^1,2^,
...
^1^ Ecosystem Modeling, Faculty of Forest Sciences and Forest Ecology University of Goettingen, Goettingen, Germany; ^2^ University of Auckland, School of Environment, Auckland 1142, New Zealand; ^3^ Jan: please fill in

*Julia.henzler@uni-goettingen.de

**Target Journals:**Methods in Ecology and Evolution, PLOS Computational Biology, Ecological Modeling, Ecosphere
...
*	Aim and Hypotheses
    +	Aim: Tool for simultaneously modeling socio-economic functions and biodiversity over time and space
    +	Connection is possible through narrow integration layer it can be easily implemented, maintained and comprehended (maybe to Abstract).	
